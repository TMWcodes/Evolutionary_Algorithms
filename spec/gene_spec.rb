...
describe Genome do
    ...
    context 'after creating a dna strand' do
        it 'checks if generated strand matches' do
            seq1 = genome.generate_strand(6) 
            seq2 = genome.dna_strand(seq1).reverse
        ...
        it 'checks if known strand matches complementary 3 to 5' do
            ...
            expect(genome.dna_strand(seq1)).to eq('ACGCTACTTACCCGAGCGAGG')
        end
        it 'checks if known strand matches 5 to 3' do
            seq1 = "TGCGATGAATGGGCTCGCTCC"
            expect(genome.dna_strand(seq1).reverse).to eq("GGAGCGAGCCCATTCATCGCA")
        end
    end
